...
typedef struct{
        ...
        uint8_t       GPIO_PinPuPdControl;	/*possible values from @GPIO_PIN_OUTPUT*/
        uint8_t       GPIO_PinOPType;		/*possible values from @GPIO_PIN_SPEED*/
...
#define          GPIO_MODE_IT_RFT     6		//RFT and FRT are same, rising falling or falling rising
