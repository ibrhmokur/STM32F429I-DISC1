...
#define	FLASH_BASEADDR		0x08000000U //compiler thinks every number is signed number. that is why, we put U.
 ...
 */
 ...
 typedef struct{
	 ...
	 __vo uint32_t FLASH_ACR;     /*!< Flash access control register,                               Address offset: 0x00 */
	 __vo uint32_t FLASH_KEYR;    /*!< Flash key register,                              			Address offset: 0x04 */
	 __vo uint32_t FLASH_OPTKEYR; /*!< Flash option key register,                            		Address offset: 0x08 */
	 __vo uint32_t FLASH_SR;      /*!< Flash status register,                                		Address offset: 0x0C */
	 __vo uint32_t FLASH_CR;      /*!< Flash control register,				                        Address offset: 0x10 */
	 __vo uint32_t FLASH_OPTCR;   /*!< Flash option control register,                          		Address offset: 0x14 */
	 __vo uint32_t FLASH_OPTCR1;  /*!< Flash option control register,                          		Address offset: 0x18 */
 ...
 */
 ...
 typedef struct{
	 ...
	 __vo uint32_t CRC_DR;     	  /*!< Data register,                               Address offset: 0x00 */
	 __vo uint32_t CRC_IDR;    	  /*!< Independent data register,                   Address offset: 0x04 */
	 __vo uint32_t CRC_CR; 		  /*!< Control register,                            Address offset: 0x08 */
 }CRC_RegDef_t;
 ...
 */
 ...
 typedef struct{
	 ...
	 __vo uint32_t PWR_CR;     	  /*!< PWR power control register ,                 Address offset: 0x00 */
	 __vo uint32_t PWR_CSR;    	  /*!< PWR power control/status register,           Address offset: 0x04 */
 }PWR_RegDef_t;
 ...
 */
 ...
 typedef struct{
	 ...
	 __vo uint32_t LISR;		/*!< DMA memory remap register,                 			Address offset: 0x00 */
	 __vo uint32_t HISR;			/*!< ,         Address offset: 0x04 */
	 __vo uint32_t LIFCR;	/*!< SYSCFG external interrupt configuration registers,   	Address offset: 0x08-0x14 */
	 __vo uint32_t HIFCR;	/*    				Address offset: 0x20 */
//ADD REST LATER
 }DMA_RegDef_t;
 ...
 */
 typedef struct
 {
     ...
     __vo uint32_t CCR;		/* I2C clock conntrol register		Address offset: 0x1C */
 ...
 */
  ...
  */
 //we used do-while loop because we used two statements
